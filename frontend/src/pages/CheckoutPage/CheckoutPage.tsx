...
const CheckoutPage: React.FC = () => {
  ...
  const {isOpen: shopIsOpen, loading: shopConfigLoading } = useShopConfig();
  ...
  // Show loading state while fetching shop config
    ...
    return (
      <div className="checkout-empty">
        <div className="checkout-empty-content">
          ...
          <h2>Laster...</h2>
          <p>Vennligst vent mens vi sjekker butikkstatus</p>
        </div>
      </div>
    );
  }
