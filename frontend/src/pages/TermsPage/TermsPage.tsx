                ...
                <div className="rounded-xl bg-white p-8 shadow-lg">
                    <div className="prose prose-gray max-w-none text-sm">
                        ...
                        <section className="mb-8">
                            ...
                            <p className="text-gray-700 mb-2"><strong>Angrefristen begynner å løpe:</strong></p>
                        ...
                        <section className="mb-8">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Oppfyllelse</h3>
                            <p className="text-gray-700 mb-3">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Heving</h3>
                            <p className="text-gray-700 mb-3">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Erstatning</h3>
                            <p className="text-gray-700">
                        ...
                        <section className="mb-8">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Retting eller omlevering</h3>
                            <p className="text-gray-700 mb-3">
                                Kjøperen kan velge mellom å kreve mangelen rettet eller levering av tilsvarende ting. Selger kan likevel motsette seg kjøperens krav dersom gjennomføringen av kravet er umulig eller volder selgeren urimelige kostnader. Retting eller omlevering skal foretas innen rimelig tid. Selger har i utgangspunktet ikke rett til å foreta mer enn to avhjelpsforsøk for samme mangel.
                            </p>

                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Prisavslag</h3>
                            <p className="text-gray-700 mb-3">
                        ...
                        <section className="mb-8">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Renter ved forsinket betaling/inkassogebyr</h3>
                            <p className="text-gray-700 mb-3">
                            ...
                            <h3 className="text-lg font-semibold text-gray-800 mt-4 mb-2">Gebyr ved uavhentede ikke-forskuddsbetalte varer</h3>
                            <p className="text-gray-700">
